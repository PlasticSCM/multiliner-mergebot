...
namespace MultilinerBot.Messages
{
    public class BuildProperties
    {
        ...
        public string TrunkBranchName { get; set; }
    ...
    public static class ParseBuildProperties
    {
            ...
            return new Dictionary<string, string>
                {
                    ...
                    { PropertyKey.TrunkBranchName, properties.TrunkBranchName },
        ...
        static class PropertyKey
        {
            ...
            internal static string TrunkBranchName = "trunk.branch.name"; 
